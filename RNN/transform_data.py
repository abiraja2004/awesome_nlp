...
for i in range(1000, len(batches), 1000):
    pickle.dump(batches[i-1000:i], open("batches/batches_{}-{}.pickle".format(i-1000,i), 'wb'))
pickle.dump(batches[i:], open("batches/batches_last.pickle", 'wb'))
